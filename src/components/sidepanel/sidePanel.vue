<template>
    <div class='side'>
        <div class='midtext' style='margin:auto;top:5%;width:100%;height:45px;background:#D9D1C7;text-align:center;display:grid;align-items:center;color:#1C1C1C'>Your Selection</div>
        <div class="counter midtext">
            ...
            <div>Selected: <span> {{ingContainer.filter(d=>d.ingName).length}}</span>/20</div>
        </div>
